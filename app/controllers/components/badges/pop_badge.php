...
define('POP_WEEK_THRESHOLD', 6);


class PopBadge extends AbstractBadge {

    private static $qualifying_species_ids;
    
    public function __construct($person_id){
        $this->person_id = $person_id;
        PopBadge::$qualifying_species_ids = array(27, 320);
    }
    ...
    public function validate(){
        ...
        $res = $badgeModel->query("SELECT Individual_ID, COUNT(DISTINCT week) c
                            FROM(
                                ...
                                "AND ssi.Species_ID IN (" . implode(",", PopBadge::$qualifying_species_ids) . ")
