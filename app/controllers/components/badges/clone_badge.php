...
define('CLONE_WEEK_THRESHOLD', 6);


class CloneBadge extends AbstractBadge{
        
    private static $qualifying_species_ids;
    
    public function __construct($person_id){
        $this->person_id = $person_id;
        CloneBadge::$qualifying_species_ids = array(35,444);
    }
    ...
    public function validate(){
        ...
        $res = $badgeModel->query("SELECT Individual_ID, COUNT(DISTINCT week) c
                            FROM(
                                ...
                                "AND ssi.Species_ID IN (" . implode(",", CloneBadge::$qualifying_species_ids) . ")
